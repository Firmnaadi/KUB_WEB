...
{	
    ...
    // update user data
    $hasil = mysqli_query($conn, "UPDATE brg_ayam SET jumlah_ayam='$jumlah_ayam' WHERE id_ayam=$id_ayam");
    ...
    $hasil = mysqli_query($conn, "SELECT * FROM brg_ayam WHERE id_ayam=$id_ayam");
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="edit_brg_ayam.php" method="POST" name="update_ayam"> 
                    <div class="form-group">
                        <label for="" class="col-form-label">Jumlah Ayam</label>
                        <input type="text" class="form-control" name="jumlah_ayam" value=<?php echo $jumlah_ayam;?>></input>
                    </div>
                    <div class="form-group">
                    <input type="hidden" name="id_ayam" value=<?php echo $_GET['id_ayam'];?>></input>
