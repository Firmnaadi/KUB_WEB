...
{	
    ...
    // update user data
    $hasil = mysqli_query($conn, "UPDATE brg_kbth_ayam SET nama_kbth='$nama_kbth',jumlah_kbth='$jumlah_kbth' WHERE id_kbth=$id_kbth");
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="edit_brg_kbth.php" method="POST" name="form1">
                <div class="form-group">
                        <label for="" class="col-form-label">Nama Barang</label>
                        <input type="text" class="form-control" name="nama_kbth" value="<?= $nama_kbth ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="col-form-label">Jumlah</label>
                        <input type="text" class="form-control" name="jumlah_kbth" value="<?= $jumlah_kbth ?>">
                        <input type="hidden" name="id_kbth" value=<?php echo $_GET['id_kbth'];?>>
                    </div>
                    <div class="form-group">
...
<body>
    ...
    <form name="update_kbth" method="post" action="edit_brg_kbth.php">
        <table border="0">
            ...
            <tr> 
                <td>jumlah</td>
                <td><input type="number" name="jumlah_kbth" value=<?php echo $jumlah_kbth;?>></td>
            </tr>
            <tr> 
