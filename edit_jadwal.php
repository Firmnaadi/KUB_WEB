...
{	
    ...
    // update user data
    $hasil = mysqli_query($conn, "UPDATE jadwal SET tanggal='$tanggal',jam='$jam',kegiatan='$kegiatan' WHERE id=$id");
...
$hasil = mysqli_query($conn, "SELECT * FROM jadwal WHERE id=$id");
...
while($data = mysqli_fetch_array($hasil))
{
    ...
    $kegiatan=$data['kegiatan'];
                ...
                ?>
                <form action="edit_jadwal.php" method="POST" name="update_jadwal"> 
                    ...
                    <div class="form-group">
                        <label for="" class="col-form-label">kegiatan</label>
