...
if (isset($_POST['submit'])) {
 ...
 if (!empty($bln)) {
  ...
  $q = mysqli_query($conn, "SELECT * FROM penjualan_ayam WHERE MONTH(tanggal) = '$bln'");
 } else {
  // perintah tampil semua data
  $q = mysqli_query($conn, "SELECT * FROM penjualan_ayam p");
 }
} else {
 // perintah tampil semua data
 $q = mysqli_query($conn, "SELECT * FROM penjualan_ayam");
}
