...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="pembelian_ayam.php" method="POST" name="form1"> 
    ...
    $result = mysqli_query($conn, "INSERT INTO pembelian_ayam(id_ayam, harga, tanggal, jumlah) VALUES( '1', '$harga', '$tanggal', '$jumlah')");
