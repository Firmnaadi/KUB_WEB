    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="penjualan_ayam.php" method="POST" name="form1">
                ...
                <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-warning">Penjualan Ayam</h6>
                        </div>      
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php
                                            if (isset($_POST['Submit'])) {
                                                ...
                                                //$result = mysqli_query($conn, "INSERT INTO penjualan_ayam(harga, tanggal, jumlah) VALUES('$harga','$tanggal','$jumlah')");
                                                // $result = mysqli_query($conn, "INSERT INTO penjualan_ayam(id_penjualan_ayam, id_ayam, harga, tanggal, jumlah) VALUES(NULL,'1','$harga','$tanggal','$jumlah')");
                                                // $jumlah = $_POST['jumlah'] * $_POST['harga'];
                                                  $result = mysqli_query($conn, "INSERT INTO penjualan_ayam(id_penjualan_ayam, id_ayam, harga, tanggal, jumlah) VALUES(NULL,'1','$harga','$tanggal','$jumlah')");
                                                  $jumlah = $_POST['jumlah'] * $_POST['harga'];
                                                echo "<tr>";
